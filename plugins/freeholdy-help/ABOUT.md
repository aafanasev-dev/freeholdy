...
plugin catalog, versions & rollback, and the `fhdeploy` Claude Code AI integration. No build
step, no dependencies, nothing to configure — it also doubles as a smoke test that
